    ...
    var a = {
        ...
        sideMenuNavigation: function(a) {
            a.find(".menu-item-has-children > a").on("click", function(s) {
                var i = n(this);
                i.siblings(".sub-menu")[0] && (s.preventDefault(),
                i.parent().hasClass("in") ? (i.parent().removeClass("in"),
                i.parent().find(".in").removeClass("in"),
                i.parent().find(".sub-menu").stop(!0).slideUp(300)) : (i.closest(".in")[0] || (a.find(".menu-item-has-children.in .sub-menu").stop(!0).slideUp(300),
        ...
        sideMenu: function() {
            ...
            $(".site-aside .menu-item-has-children").children("a").append('<span class="menu-sign iconfont icon-chevron-down"></span>');
            n(".navbar-site")[0],
            $(".navbar-site .menu-item-has-children").children("a").append('<span class="menu-sign iconfont icon-chevron-down"></span>');
